...
let MascotaServiceService = class MascotaServiceService {
    ...
    crearEspecie(especie) {
        ...
        return this.http.post("https://cloudcomputing.ups.edu.ec/TesisVeterinariaApi/rest/prueba/registrarEspecie", body.toString(), {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded'),
            responseType: 'text'
        });
    }
    editarEspecie(especie, nombreEspecie) {
        ...
        return this.http.post("https://cloudcomputing.ups.edu.ec/TesisVeterinariaApi/rest/prueba/editarEspecie", body.toString(), {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded'),
            responseType: 'text'
        });
    }
    eliminarEspecie(especie) {
        ...
        const body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpParams()
            .set('idEspecie', especie);
        return this.http.post("https://cloudcomputing.ups.edu.ec/TesisVeterinariaApi/rest/prueba/eliminarEspecie/", body.toString(), {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded'),
            responseType: 'text'
        });
    }
    crearRaza(raza) {
        ...
        return this.http.post("https://cloudcomputing.ups.edu.ec/TesisVeterinariaApi/rest/prueba/registrarRaza", body.toString(), {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded'),
            responseType: 'text'
        });
    }
    editarRaza(especie, nombreEspecie, nombreRaza) {
        ...
        const body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpParams()
            ...
            .set('nombreEspecie', nombreEspecie);
        return this.http.post("https://cloudcomputing.ups.edu.ec/TesisVeterinariaApi/rest/prueba/editarRaza", body.toString(), {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded'),
            responseType: 'text'
        });
    }
    eliminarRaza(raza) {
        ...
        const body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpParams()
            .set('idRaza', raza);
        return this.http.post("https://cloudcomputing.ups.edu.ec/TesisVeterinariaApi/rest/prueba/eliminarRaza", body.toString(), {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded'),
            responseType: 'text'
        });
    }
